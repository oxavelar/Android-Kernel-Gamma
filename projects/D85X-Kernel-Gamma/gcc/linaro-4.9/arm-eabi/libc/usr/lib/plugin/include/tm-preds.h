/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/tcwg-buildslave/workspace/tcwg-make-release/label/tcwg-x86_64-ex40/target/arm-eabi/snapshots/gcc-linaro-4.9-2016.02/gcc/config/arm/arm.md'.  */
