...
enum opt_code
{
  ...
  OPT_mcmse = 1194,                          /* -mcmse */
  OPT_mcpu_ = 1195,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1196,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1197,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1198,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1199,                  /* -mfp16-format= */
  OPT_mfpu_ = 1200,                          /* -mfpu= */
  /* OPT_mhard_float = 1201, */              /* -mhard-float */
  OPT_mlittle_endian = 1202,                 /* -mlittle-endian */
  OPT_mlong_calls = 1203,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1204,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1205,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1206,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1207,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1208,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1209,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1210,               /* -mprint-tune-info */
  OPT_mrestrict_it = 1211,                   /* -mrestrict-it */
  OPT_msched_prolog = 1212,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1213,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1214,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1215, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1216,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1217,                         /* -mthumb */
  OPT_mthumb_interwork = 1218,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1219,                  /* -mtls-dialect= */
  OPT_mtp_ = 1220,                           /* -mtp= */
  OPT_mtpcs_frame = 1221,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1222,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1223,                         /* -mtune= */
  OPT_munaligned_access = 1224,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1225,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1226,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1227,              /* -mword-relocations */
  OPT_n = 1228,                              /* -n */
  OPT_no_canonical_prefixes = 1229,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1230,              /* -no-integrated-cpp */
  OPT_no_pie = 1231,                         /* -no-pie */
  ...
  OPT_pie = 1244,                            /* -pie */
  OPT_pipe = 1245,                           /* -pipe */
  OPT_print_file_name_ = 1246,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1247,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1248,          /* -print-multi-directory */
  OPT_print_multi_lib = 1249,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1250,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1251,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1252,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1253,               /* -print-prog-name= */
  OPT_print_search_dirs = 1254,              /* -print-search-dirs */
  OPT_print_sysroot = 1255,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1256,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1257,                          /* -quiet */
  OPT_r = 1258,                              /* -r */
  OPT_remap = 1259,                          /* -remap */
  OPT_s = 1260,                              /* -s */
  OPT_s_bc_abi = 1261,                       /* -s-bc-abi */
  OPT_save_temps = 1262,                     /* -save-temps */
  OPT_save_temps_ = 1263,                    /* -save-temps= */
  OPT_shared = 1264,                         /* -shared */
  OPT_shared_libgcc = 1265,                  /* -shared-libgcc */
  /* OPT_specs = 1266, */                    /* -specs */
  OPT_specs_ = 1267,                         /* -specs= */
  OPT_static = 1268,                         /* -static */
  OPT_static_libasan = 1269,                 /* -static-libasan */
  OPT_static_libgcc = 1270,                  /* -static-libgcc */
  OPT_static_libgcj = 1271,                  /* -static-libgcj */
  OPT_static_libgfortran = 1272,             /* -static-libgfortran */
  OPT_static_libgo = 1273,                   /* -static-libgo */
  OPT_static_liblsan = 1274,                 /* -static-liblsan */
  OPT_static_libmpx = 1275,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1276,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1277,               /* -static-libstdc++ */
  OPT_static_libtsan = 1278,                 /* -static-libtsan */
  OPT_static_libubsan = 1279,                /* -static-libubsan */
  /* OPT_std_c__03 = 1280, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1281, */                /* -std=c++0x */
  OPT_std_c__11 = 1282,                      /* -std=c++11 */
  OPT_std_c__14 = 1283,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1284, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1285, */                /* -std=c++1y */
  OPT_std_c__1z = 1286,                      /* -std=c++1z */
  OPT_std_c__98 = 1287,                      /* -std=c++98 */
  OPT_std_c11 = 1288,                        /* -std=c11 */
  /* OPT_std_c1x = 1289, */                  /* -std=c1x */
  /* OPT_std_c89 = 1290, */                  /* -std=c89 */
  OPT_std_c90 = 1291,                        /* -std=c90 */
  OPT_std_c99 = 1292,                        /* -std=c99 */
  /* OPT_std_c9x = 1293, */                  /* -std=c9x */
  OPT_std_f2003 = 1294,                      /* -std=f2003 */
  OPT_std_f2008 = 1295,                      /* -std=f2008 */
  OPT_std_f2008ts = 1296,                    /* -std=f2008ts */
  OPT_std_f95 = 1297,                        /* -std=f95 */
  OPT_std_gnu = 1298,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1299, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1300, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1301,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1302,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1303, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1304, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1305,                    /* -std=gnu++1z */
